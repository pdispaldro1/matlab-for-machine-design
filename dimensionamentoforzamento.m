...
d_albero = input("Inserisci il diametro in mm dell'albero: "); %valore del diametro dell'albero
d_mozzo = input("Inserisci il diametro in mm del mozzo: "); %valore del diametro del mozzo
mt = input("Inserisci il valore in Nmm del momento torcente agente sull'albero in Nm: "); %inserisci il valore del momento torcente agente sull'albero in Nm
...
disp("Questa è la lunghezza minima in mm del collegamento")

l_maggiorato = n*l %valore della lunghezza del collegamento maggiorata col coefficiente di sicurezza allo scorrimento
disp("Questa è la lunghezza in mm, opportunamente maggiorata mediante il coefficiente di sicurezza allo scorrimento, del collegamento")
end
