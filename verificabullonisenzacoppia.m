...
sigma_adm_lamiera = input ("Inserisci il valore della sigma ammissibile della lamiera: "); %valore della sigma ammissibile dalla lamiera
b = input ("Inserisci il valore dello spessore della lamiera: "); %valore dello spessore della lamiera
